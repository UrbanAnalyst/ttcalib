...
origins and destinations in the Uber Movement data. The best model corresponded
to an r-squared correlation of 0.697 for an effective waiting time at traffic
lights of 16 seconds in peak hour traffic (7-10 am). Corresponding effective
waiting times to turn across oncoming traffic were only 1 second.
