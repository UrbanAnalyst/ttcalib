...
The median log-10 ratio is -0.003, or a ratio of 1.008, implying that the
observed times are only ever so slightly slower than the estimated times.

### Correlation

The estmiated and observed travel times are highly correlated, with an
R-squared value of around 0.64, or 0.933 on a logarithmic scale. These values
